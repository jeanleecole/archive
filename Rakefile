...
task :generate_derivatives, [:thumbs_size, :density, :missing, :im_executable] do |t, args|
  ...
  [thumb_image_dir].each &$ensure_dir_exists
  ...
  field_names = "object_location,image_thumb".split(",")
  # open file
